...
There are a couple of preceding examples of non-collateralized stablecoins like BasisCoin and Empty Set Dollar but none of the coins has succeeded in stabilizing the currency price in the long run. This is not a solved problem. JohnLawCoin is yet another experiment to solve the problem by addressing issues of the existing stablecoins.
