...
class BondOperationUnitTest(unittest.TestCase):
    ...
    def run(self):
        ...
        if (self._bond_price >= 2 and
            ...
            self.check_purchase_bonds(accounts[2], 1, t1)
            ...
            self.check_purchase_bonds(accounts[1], 10, t2)
            ...
            self.check_purchase_bonds(accounts[3], 48, t3)
            ...
            self.assertEqual(bond_operation.bond_budget, 0)
            self.check_redeem_bonds(accounts[2], [t1], 11, 0)
            ...
            coin_supply = self.coin.total_supply
            bond_supply = self.bond.total_supply
            self.check_redeem_bonds(accounts[2], [t6, t7, t8], 0, 0)
            self.assertEqual(self.bond.balance_of(accounts[2], t6), 20)
            self.assertEqual(self.bond.balance_of(accounts[2], t7), 20)
            self.assertEqual(self.bond.balance_of(accounts[2], t8), 20)
            self.check_redemption_epochs(self.bond, accounts[2], [t6, t7, t8])
            ...
            coin_supply = self.coin.total_supply
            bond_supply = self.bond.total_supply
            self.check_redeem_bonds(accounts[2], [t6, t7, t8], 5, 0)
            ...
            coin_supply = self.coin.total_supply
            bond_supply = self.bond.total_supply
            self.check_redeem_bonds(accounts[2], [t8, t7, t6], 5, 0)
            self.assertEqual(self.bond.balance_of(accounts[2], t6), 15)
            self.assertEqual(self.bond.balance_of(accounts[2], t7), 20)
            ...
            coin_supply = self.coin.total_supply
            bond_supply = self.bond.total_supply
            self.check_redeem_bonds(accounts[2], [t7], 5, 0)
            self.assertEqual(self.bond.balance_of(accounts[2], t6), 15)
            ...
            coin_supply = self.coin.total_supply
            bond_supply = self.bond.total_supply
            self.check_redeem_bonds(accounts[2], [t7, t8], 1, 0)
            self.assertEqual(self.bond.balance_of(accounts[2], t6), 0)
            ...
            coin_supply = self.coin.total_supply
            bond_supply = self.bond.total_supply
            self.check_redeem_bonds(accounts[2], [t8, t7], 16, 0)
            self.assertEqual(self.bond.balance_of(accounts[2], t6), 0)
            ...
            coin_supply = self.coin.total_supply
            bond_supply = self.bond.total_supply
            self.check_redeem_bonds(accounts[2], [t8], 1, 0)
            self.assertEqual(self.bond.balance_of(accounts[2], t6), 0)
            self.assertEqual(self.bond.balance_of(accounts[2], t7), 0)
            ...
            coin_supply = self.coin.total_supply
            bond_supply = self.bond.total_supply
            self.check_redeem_bonds(accounts[2], [t8], 7, 0)
            self.assertEqual(self.bond.balance_of(accounts[2], t6), 0)
            self.assertEqual(self.bond.balance_of(accounts[2], t7), 0)
        ...
        self.check_redeem_bonds(accounts[2], [t1], 10, 0)
        self.check_redeem_bonds(accounts[2], [t1], 0, 0)
        ...
        self.check_redeem_bonds(accounts[2], [t2], 20, 0)
        self.check_redeem_bonds(accounts[2], [t2], 0, 0)
        ...
        self.check_redeem_bonds(accounts[2], [t1], 0, 10)
        ...
        self.check_redeem_bonds(accounts[2], [t2], 0, 20)
    ...
    def check_redeem_bonds(self, account, redemption_epochs,
                           redeemed_bonds, expired_bonds):
        (ret1, ret2) = self.bond_operation.redeem_bonds(
